...
planete_1.peupler_le_monde(320,220,60,100,100)
...
class GraphicalDisplay(Planet):
    ...
    def __init__(self, largeur_de_la_grille, hauteur_de_la_grille):
        ...
        self.image_algue = pygame.image.load('algue.jpg')
        self.image_rock = pygame.image.load('pierre.jpg')
            ...
            for y in range(self.hauteur_de_la_grille):
                for x in range(self.largeur_de_la_grille):
                    if self.grille[y][x] == '\U0001f41f':
                        ...
                        self.screen.blit(self.image_algue, (x * 40, y * 40))
                    elif self.grille[y][x] == '🪨':
                        self.screen.blit(self.image_rock, (x*40, y * 40))
...
# planete_1= GraphicalDisplay(50,50)
# # # Initialiser la taille de la grille
# planete_1.peupler_le_monde(320,220,60,100,100)
# # # Initialiser le nombre de poissons, de requins, de rocks et d'algues
# planete_1.simuler(5)
...
#test pygame
#planete2.peupler_le_monde(320,220,60,100,100)